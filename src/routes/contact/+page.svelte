<script>
	...
	$: config = $currentLanguage === 'ES' ? getContactConfig('ES') : getContactConfig('EN');
</script>

<svelte:head>
	<title>Contact - Santiago Toquica Yanguas</title>
	<meta name="description" content="Get in touch with Santiago Toquica Yanguas - Software Engineer" />
</svelte:head>
