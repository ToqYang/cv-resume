...
const cvDataByLanguage: Record<'EN' | 'ES', CVData> = {
	EN: {
		personal: {
			...
			phone: '+57 3156446539',
			location: 'Colombia',
			website: 'https://toqyang.github.io/cv-resume/',
		...
		training: [
			{
				name: 'Exchange Modern Application Development with Python on AWS Specialization by AWS Certified Solutions Architect – Associate',
				provider: 'Coursera',
			...
			},
			{
				...
				link: 'https://www.coursera.org/account/accomplishments/specialization/certificate/9BN3HM7D4U8B'
			}
		],
		projects: [
			{
	...
	ES: {
		...
		experience: [
			...
			{
				title: 'SSR Desarrollador Backend',
				company: 'Symplifica',
				period: '02/2022 - 07/2023',
		...
		training: [
			{
				name: 'Intercambio de Desarrollo de Aplicaciones Modernas con Python en AWS por Arquitecto de Soluciones Certificado por AWS – Asociado',
				provider: 'Coursera',
				link: 'https://www.credly.com/badges/7ab605d5-72f6-4259-a66b-cca16423c89a/public_url'
			},
			{
		...
		projects: [
			...
			{
				name: 'Printf',
				description: 'Implementación de la función printf en C, manejando varios especificadores de formato y tipos de datos con una gestión de memoria adecuada.',
				technologies: ['C', 'Gestión de Memoria'],
				link: 'https://github.com/ToqYang/printf'
			},
			{
				name: 'Simple shell',
				description: 'Una implementación de un shell de línea de comandos en C que soporta comandos básicos de shell, variables de entorno y gestión de procesos.',
				technologies: ['C', 'Shell Scripting'],
				link: 'https://github.com/ToqYang/simple_shell'
			},
			{
